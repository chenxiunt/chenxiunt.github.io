...
Dr. Qiu's research interests span the areas of **statistical privacy** and **optimization for privacy**, with a focus on developing principled solutions with rigorous privacy guarantees and provable utility–efficiency trade-offs. His research results have been published in top-tier conferences and journals (e.g., CCS, USENIX Security, NDSS, PETS, INFOCOM, AAMAS, IJCAI, EDBT, ICDCS, CIKM, SIGSPATIAL, IPSN, Transactions on Networking (ToN), Transactions on Cloud Computing (TCC), Transactions on Mobile Computing (TMC), Transactions on Parallel and Distributed Systems (TPDS), and Transactions on Computers (TC)). His research has received a **Distinguished Paper Award at CCS 2025**, **Best Transactions Paper Award at IEEE T-ITS**, and **Best Paper Award at CloudCom 2016**. His CV can be found [here](https://github.com/chenxiunt/chenxiunt.github.io/blob/master/assets/pdf/CV.pdf). 
